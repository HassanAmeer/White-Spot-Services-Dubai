...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="../book-online/assets/images/favicon.png">
    ...
    <link rel="stylesheet" href="../book-online/jscss/bootstrap.min.css"/>
    <link rel="stylesheet" href="../book-online/jscss/locationpicker.jquery.js">
...
crossorigin=""></script>
  ...
  <body style="background: white;">
    ...
    <nav class="navbar navbar-dark bg-dark d-flex justify-content-between" style="position:sticky;top:0;z-index:100;">
        <div class="align-self-start" style="margin-left:1rem;"><a href="tableservices.php" style="text-decoration:none;" class="fas fa-arrow-left text-light"> back </a></div>
...
<div class="card-header" style="position:sticky;bottom:0;z-index:100; display:flex; flex-direction:row;justify-content:space-evenly">
  ...
  <script src="../book-online/jscss/bootstrap.min.js"></script>
  <script src="../book-online/jscss/jqoffline3.6.1.js"></script>
<script src="../book-online/jscss/locationpicker.jquery.js"></script>
<script src="../book-online/chart.js"></script>
<script>
...
const map = L.map('map'); 
// Initializes map
map.setView([<?php echo $vservices['lat']; ?>, <?php echo $vservices['lng']; ?>], 13); 
