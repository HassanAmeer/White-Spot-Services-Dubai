...
<a type="button" href="profile.php" target="_blank" class="p-4 mx-3 input-group-text rounded-pill" id="dashboardbtn" style="height:1.2rem !important; margin-top:0.5rem; display:none; text-decoration:none;">
             ...
             <div class="col-md-12 form-group view-map">
                <div class="display-map-search">
                   <div class="content-display">
                      ...
                      <input type="text" style="border: none;width: 100%;" placeholder=" your building or area" class="picklocinpt pac-target-input" autocomplete="off">
                   </div>
                </div>
             </div>
          </div>
...
$dayName1 = date("D", time());
$phpdate1 = date( "d-M-Y", time());
$phpday1 = date( "d", time());

echo '<div class="owl-item" style="width: auto; margin-right: 10px;">
<div class="item"><div class="field">
    <span class="day">'.$dayName1.'</span>
    <button type="button" class="num days active" data-full="'.$dayName1.', '.$phpdate1.'" data-value="'.$dayName1.'">'.$phpday1.'</button>
    </div></div></div>';
...
if($chkpaytype == 0){
               ...
               echo '<div class="col-md-12 form-group pay-with-credit">
                     <label class="container-radio">
                         <p>Pay with credit / debit card <br> 
                         <!--<span>AED 1000 insurance when you pay online</span>-->
                         </p>
                         <input type="radio" name="payment_type" checked="" class="selectpaymenttypes" value="bycc">
                         <span class="checkmark-radio"></span>
                      </label>
                   ...
                   <div class="col-md-12 form-group pay-with-cash" style="margin-top: 5px;">
                     <label class="container-radio">
                         <p>Pay with cash</p>
                         <input type="radio" name="payment_type" class="selectpaymenttypes" value="byhands" disabled>
                         <span class="checkmark-radio"></span>
                      </label>
                   </div>';
   ...
   <label class="container-radio">
       ...
       <input type="radio" name="payment_type" class="selectpaymenttypes" value="bycc" disabled>
       <span class="checkmark-radio"></span>
    </label>
    <div class="input-group mb-2" id="vontypecc" style="display:none;">
      <span class="input-group-text fa fa-credit-card" id="basic-addon1">  </span>
...
if(chklocationval == 'Dubai'){
   ...
   var userloc = $('.picklocinpt').val();
  localStorage.setItem('foranualloc', userloc);
  var userlat = $('.lat').val();
  localStorage.setItem('userlat', userlat);
   var userlng = $('.lng').val();
   localStorage.setItem('userlng', userlng);
  window.location.href="anual/index.php";
}
